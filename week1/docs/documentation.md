...
- Git 2.42.0
OS: Windows 11
![Workflow display](./screenshots/git-version.png)

![Workflow display](./screenshots/github-connectivity.png)

## Terminal - Bash CLI
- Purpose: Command-line operations
- Verification: `uname -a`
- Terminal: 10.0-22621
![Workflow display](./screenshots/os-and-bash.png)

## VS Code
- Purpose: Code editor
- Verification: `code --version`
- VS code: 1.108.1
![Workflow display](./screenshots/vs-code.png)

## Docker
- Purpose: Containerization
- Verification: `docker --version`
- Docker 24.0.2
![Workflow display](./screenshots/docker.png)
...
![Workflow display](./screenshots/azure-CLI.png)
...
Git download from https://git-scm.com/install/

Docker desktop from: https://docs.docker.com/desktop/setup/install/windows-install/
                    
Azure CLI Installed from https://learn.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest
...
- Screenshots and text outputs saved in `week1/src/`  
